...
fn entity_mapping() {
    ...
    app.add_plugins(MinimalPlugins)
        ...
        .register_rollback_component_with_reflect::<ChildEntity>()
        .register_rollback_component_with_reflect::<ParentEntity>()
        .register_rollback_resource_with_reflect::<FrameCounter>()
